...
export const ObligationEnrichmentMap: EnrichmentMap = {
    ...
    'mktg-consent': {
        ...
        default: { source: 'GDPR Art. 7 + ePrivacy Directive 2002/58', penalty: 'up to €20M or 4% of turnover', penaltyMaxEur: 20000000, due: 'Ongoing', scope: 'national-pending' , penaltyCeiling: { kind: 'turnover', percent: 4, orAmount: { value: 20000000, currency: 'EUR' }, basis: 'DSGVO Art. 83 Abs. 5 Buchst. a', asOf: '2026-09-17' } },
    },
    'mktg-health-claims': {
    ...
    'data-privacy': {
        ...
        default: { source: 'GDPR Art. 13 / Art. 6', penalty: 'up to €20M or 4% of turnover', penaltyMaxEur: 20000000, due: 'Ongoing', scope: 'eu' , penaltyCeiling: { kind: 'turnover', percent: 4, orAmount: { value: 20000000, currency: 'EUR' }, basis: 'DSGVO Art. 83 Abs. 5 Buchst. a und b', asOf: '2026-09-17' } },
    },
    'data-hosting': {
        default: { source: 'GDPR Chapter V (transfers) + SCCs', penalty: 'transfer suspension + GDPR fines', penaltyMaxEur: 20000000, due: 'One-off', dueDays: 90, scope: 'eu' , penaltyCeiling: { kind: 'turnover', percent: 4, orAmount: { value: 20000000, currency: 'EUR' }, basis: 'DSGVO Art. 83 Abs. 5 Buchst. c', asOf: '2026-09-17' } },
