...
export const ObligationEnrichmentMap: EnrichmentMap = {
    ...
    'data-privacy': {
        ...
        US: { source: 'CCPA/CPRA + state privacy acts', penalty: '$2,500–$7,500 per violation', penaltyMaxEur: 50000, due: 'Ongoing', penaltyCeiling: { kind: 'subnational', level: 'statesWithPrivacyActs', basis: 'Cal. Civ. Code § 1798.155 (CCPA/CPRA) und die Parallelgesetze der übrigen Staaten', note: 'Es gibt kein allgemeines Bundesdatenschutzgesetz; jeder Staat mit eigenem Gesetz setzt eigene Sätze. Die geführten stehen in `states`. Für New York fehlt der Zugang zum Gesetzestext, nicht das Gesetz — siehe STAATEN_OHNE_ZUGANG im Wächter.' }, states: {
