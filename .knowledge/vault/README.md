...
| Was | Wo | Inhalt |
|---|---|---|
| **Obsidian-Vault „Complihub360"** | Repo `sertdemir/complihub360-vault`, Ordner `Complihub360/` | laufendes Projekt-Gedächtnis, Ordner `00`–`99` (seit 2026-09-01 versioniert, vorher nur lokal) |
