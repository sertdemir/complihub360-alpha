...
Deno.serve(async (req: Request) => {
  ...
  if (req.method === 'GET') {
    ...
    return new Response(page('Request more info', 'Ask the client for more information?', 'The client will be prompted to provide additional details for this request.', '#C5913B', form), {
