...
Deno.serve(async (req: Request) => {
  ...
  if (req.method === 'GET') {
    ...
    return new Response(page('Confirm request', 'Confirm this engagement request?', 'Clicking confirm accepts the request, notifies the client and stops your SLA timer.', '#C5913B', form), {
