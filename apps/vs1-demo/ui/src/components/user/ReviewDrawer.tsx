      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <textarea value={body} onChange={(e) => setBody(e.target.value)} rows={4} placeholder={t('review.bodyPh')}
            className="w-full rounded-lg border border-stroke bg-transparent px-3.5 py-2.5 text-[13px] text-fg placeholder:text-fg-tertiary focus:outline-none focus:ring-1 focus:ring-[#097070]" />
        </div>
