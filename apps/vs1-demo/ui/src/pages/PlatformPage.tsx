...
const HEADER_MENU = [
  ...
  },
  {
    ...
    label: 'Solutions',
    items: [
      { title: 'Founders & CEOs', desc: 'Minimise risk & scale faster', path: '/founders' },
      { title: 'Operations Teams', desc: 'Automate daily compliance', path: '/operations' },
      { title: 'In-House Counsel', desc: 'Cut research time by 90%', path: '/counsel' },
    ]
  },
  {
    id: 'areas',
  ...
  },
  {
    ...
    label: 'Resources',
    items: [
      { title: 'Customer Stories', desc: 'See real compliance outcomes', path: '#stories' },
      { title: 'Guides & Whitepapers', desc: 'In-depth market deep-dives', path: '#guides' },
    ]
  }
];
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (item.path.startsWith('/platform#')) {
                        const anchor = item.path.replace('/platform#', '');
