    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between gap-6 relative">
        ...
        <div className="flex items-center gap-3 shrink-0 z-10">
          <button className="hidden tablet:inline-flex text-neutral-600 hover:text-neutral-900 text-ui-small font-semibold px-4 py-2 rounded-md hover:bg-neutral-100 transition-colors" onClick={() => navigate('/login')}>
            Log in
          </button>
