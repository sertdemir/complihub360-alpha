...
function TabBar({ active, onChange }: { active: string; onChange: (id: string) => void }) {
  ...
  const tabs = [
    { id: 'stories', label: t('resources.tabStories', 'Customer Stories'), icon: Users },
    { id: 'guides', label: t('resources.tabGuides', 'Guides & Whitepapers'), icon: BookOpen },
  ];
    ...
    >
      ...
      <div className="p-6">
        ...
        <Typography variant="caption" className="text-success-500 font-semibold uppercase tracking-wider mb-2 block">
          {t('resources.stories.outcomeLabel', 'Outcome')}
        </Typography>
        ...
        <div className="flex flex-wrap gap-2">
          {story.tags.map(tag => (
            <span key={tag} className="text-xs bg-neutral-50 border border-neutral-200 px-2.5 py-1 rounded-md text-neutral-500 font-medium">
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl mb-12">
            <Typography variant="caption" className="text-primary-500 mb-3 block font-semibold">
              {t('resources.stories.overline', 'Customer Stories')}
            </Typography>
            <Typography variant="display" weight="bold" className="text-neutral-900 mb-5 leading-tight">
              {t('resources.stories.title', 'Real Compliance Outcomes, Not Marketing Claims')}
            </Typography>
            <Typography variant="body" className="text-neutral-600 text-lg leading-relaxed">
              {t('resources.stories.body', 'See how businesses like yours used CompliHub360 to navigate complex cross-border compliance — from uncertainty to resolution.')}
            </Typography>
          </div>
      ...
      <section id="guides" className="py-16 desktop-s:py-20 bg-neutral-50 scroll-mt-28">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl mb-12">
            <Typography variant="caption" className="text-primary-500 mb-3 block font-semibold">
              {t('resources.guides.overline', 'Guides & Whitepapers')}
            </Typography>
            <Typography variant="display" weight="bold" className="text-neutral-900 mb-5 leading-tight">
              {t('resources.guides.title', 'Knowledge That Builds Compliance Confidence')}
            </Typography>
            <Typography variant="body" className="text-neutral-600 text-lg leading-relaxed">
              {t('resources.guides.body', 'In-depth market deep-dives, regulatory breakdowns, and practical checklists — curated by our compliance intelligence engine and reviewed by specialists.')}
            </Typography>
          </div>
          ...
          >
            ...
            <div className="flex-1">
              <Typography variant="h3" weight="bold" className="text-white mb-2">
                {t('resources.guides.kbTitle', 'Living Knowledge Base')}
              </Typography>
              <Typography variant="body" className="text-primary-300 leading-relaxed">
                {t('resources.guides.kbBody', 'Every platform update, new compliance rule, or partner integration triggers a dedicated content update. Our guides are evergreen — automatically maintained and verified against the latest regulatory sources.')}
              </Typography>
            </div>
            <button
            ...
            >
              {t('resources.guides.kbCta', 'Get Notified')}
              <ArrowRight size={16} />
            </button>
          </motion.div>
        </div>
      ...
      <section className="py-16 desktop-s:py-24 bg-primary-900">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <Typography variant="display" weight="bold" className="text-white mb-5">
            {t('resources.cta.title', 'Ready to become compliant?')}
          </Typography>
          <Typography variant="body" className="text-primary-300 mb-10 text-lg">
            {t('resources.cta.body', 'Join businesses that turned compliance uncertainty into structured action plans.')}
          </Typography>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              {t('resources.cta.btnAssessment', 'Start Free Assessment')}
            </button>
            <button
            ...
            >
              {t('resources.cta.btnPlatform', 'Explore Platform')}
              <ArrowRight size={18} />
            </button>
          </div>
        </div>
